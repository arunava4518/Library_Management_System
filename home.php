...
body{
  ...
  .box{
    ...
    background-image: url("Digital_book.jpg");
...
<body>
  <div class="box">
   <table  style =" font-size:16pt"  align="center" width="100%" height="100%" >
      <tr>
        <td style="color:red"><h1 align="center"><marquee><u>Welcome To MY BOOKS</u></marquee></td></h1>
      </tr>
      echo</br>;
      <tr>
    ...
    <form method="post" action="" style="background:rgba(0,0,0,0.38);color:blue;"">
      <div  class="boxtwo" style="border:solid 1px #CF0403;border-radius: 10px; width:73.5%; height:360px; margin-left:13%;margin-top:15px; background-image:url(jio12.jpg);">

        <fieldset align="center" style=" background-image:url(jio.jpg);" class="five" class="one">
          <div class="boxfour" style="align:center">
            <h3 style="color:white;text-align:center;;padding-top:1px;padding-bottom: 1px;background:red;border-radius:12px;margin-top:-13px;margin-left:-12px;height:40px">Please Login Here</h3>
        ...
        <table style="font-size:16pt;width:300px;height:50px;margin-right:45px;" align="Right">
          ...
          <tr>
            <td align="center" style="margin-left:200px;"><input type="submit" style="background-color:red;" name="submit" value="LOGIN"></td>
          </tr>
