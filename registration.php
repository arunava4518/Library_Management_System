...
<body>
  <div class="box" style="background-color:red">
   <table  style =" font-size:16pt" align="center" width="100%" height="100%">
      <tr>
        <td style="color:red"><h1 align="center"><marquee ><i>Welcome To MY BOOKS</i>  </marquee></h1></td>
      </tr>
      <tr>
  ...
  <br><br>
  <div  class="boxtwo" style="border:solid 1px #CF0403;border-radius: 10px; width:73.5%; height:370px; margin-left:13%;margin-top:10px;background-image:url(jio.jpg)">
